...
setInterval(function() {
    ...
    addMoeda(banco*2000)
    document.getElementById('moeda').innerHTML = moedas
    document.title = moedas + " moedas - Empreendedorismo Ultimate Pro Max"
    MoedasPS()
}, 1000)
...
function load() {
    ...
    if (typeof baz.qworker !== undefined) prole = baz.qworker
    if (typeof baz.cworker !== undefined) proleCusto = baz.cworker
    if (typeof baz.qmina !== undefined) minaOuro = baz.qmina
    if (typeof baz.cmina !== undefined) minaOuroCusto = baz.cmina
    if (typeof baz.qbanco !== undefined) banco = baz.qbanco
    if (typeof baz.cbanco !== undefined) bancoCusto = baz.cbanco
}